...
def test(model_path, overwrite=False):
    ...
    model = models.init_model(unit_size=conf['unit_size'], conf=conf, model_path=weights_path)      
...
if __name__ == "__main__":
    ...
    model_path = os.path.join(conf['root_path'],'data/models/ma-fl-mia/federated/',args.model_id)
    if args.test_all:
        test_all(model_path)
    else:
